[![Build Status](https://travis-ci.org/ING-Group/tpa-spending-categories.svg?branch=master)](https://travis-ci.org/ING-Group/tpa-spending-categories)

# tpa-spending-categories

An element providing a visual representation of the spending categories
...
And you can run it via:
	...
	polylint -i tpa-spending-categories.html
...
`http://localhost:8080/components/tpa-spending-categories/`, where `tpa-spending-categories` is the name of the directory containing it.


## Testing Your Element

Simply navigate to the `/test` directory of your element to run its tests. If
you are using Polyserve: `http://localhost:8080/components/tpa-spending-categories/test/`
